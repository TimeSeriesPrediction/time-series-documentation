...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			...
			% University Logo
			\includegraphics[width=0.6\textwidth]{up_logo.jpg}\\[2.0cm] 
    ...
    \section{Using the software}
        ...
        \includegraphics[width=1\textwidth]{login.PNG}\\[1.0cm] 
    	...
    	If a user happens to forget their password, they may use the forgot password link available on the login screen. The user will then have an email sent to the email account linked to their username. Once the email is received, the user will have an hour in order to follow the link given in order to enter a new password. Each reset is unique and will only work once.\\[1.0cm]
         ...
         \includegraphics[width=1\textwidth]{reset-password.PNG}\\[1.0cm] 
        ...
        \includegraphics[width=1\textwidth]{add-bulk-students.PNG}\\[1.0cm]  
        ...
        \includegraphics[width=1\textwidth]{assignments.PNG}\\[1.0cm]
        ...
        \includegraphics[width=1\textwidth]{enroll-students.PNG}\\[1.0cm]
     	\pagebreak
        ...
        \includegraphics[width=1\textwidth]{student-view-marks.PNG}\\[1.0cm]
        ...
        \includegraphics[width=1\textwidth]{weightings.PNG}\\[1.0cm]
        ...
        \includegraphics[width=1\textwidth]{student-query.PNG}\\[1.0cm]
        ...
        \includegraphics[width=1\textwidth]{admin-query.PNG}\\[1.0cm]
